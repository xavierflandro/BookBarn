...
namespace WaterProject.Infrastructure
{
    ...
    public class PageLinkTagHelper : TagHelper
    {
        ...
        public PagingInfo PageModel { get; set; }   // this property is an instance of the PagingInfo Class
        ...
        //  OVERLOADING: methods with the same name that recieve different argument/number of arguments
        //  OVERWRITING: rewriting a native method as below
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            for (int i = 1; i <= PageModel.Totalpages; i++)     //  Loop through all pages starting at 1
            {
                ...
                // append a tags to div tag 'result'
